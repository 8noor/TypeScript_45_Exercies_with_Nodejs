...
// The function should print a simple sentence, such as Karachi is in Pakistan. Give the parameter
 // for the country a default value. Call your function for three different cities, at least 
 ...
 describe_city("karachi");  // default statement
 describe_city("france", "eurape");
